...
const AddProduct = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            // Very simplified version for adding product mimicking form
            // Cloudinary upload logic would ideally go here if we attach the actual files.
            // For now to support the mock flows, we will push the generic logic.
            const config = {
                headers: {
            ...
            const payload = {
                ...
                images: previewUrls.length > 0 ? [] : ['https://placehold.co/600x600'] // mock fallback
            };
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-8 pt-8">
                ...
                <div className="flex flex-col sm:flex-row justify-between sm:items-end mb-8 gap-4">
                    <div>
                        ...
                        <p className="text-gray-500 mt-2 font-medium">Share your latest creation with the world.</p>
                    </div>
                    <div className="flex items-center gap-3">
                        <button className="px-6 py-2.5 bg-white border border-gray-200 hover:bg-gray-50 text-gray-900 font-bold rounded-full shadow-sm transition-colors cursor-not-allowed">
                            Save Draft
                        </button>
                    </div>
                </div>
                ...
                <form onSubmit={submitHandler}>
                    ...
                    <div className="mt-8 border-t border-gray-200 pt-8 flex justify-end items-center gap-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`px-8 py-3.5 bg-[#49cc2f] hover:bg-[#3fb826] text-white font-bold rounded-full shadow-sm transition-colors flex items-center justify-center gap-2 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`}
                        >
